...
- [XOS Faucet](https://faucet.x.ink/)
- Register [XOS Airdrop](X.ink/1V7NKQ)
- Xos Airdrop BOT [Here](http://github.com/vonssy/Xos-BOT)
...
1. **Clone The Repositories:**
   ```bash
   git clone https://github.com/vonssy/XosDex-BOT.git
   ```
   ```bash
   cd XosDex-BOT
   ```
